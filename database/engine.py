...
try:
    ...
    # expire_on_commit=False — об'єкти зберігають атрибути після закриття сесії
    # (без цього SQLAlchemy інвалідує всі атрибути після виходу з `with` блоку,
    # що призводить до DetachedInstanceError або повернення None для нових полів)
