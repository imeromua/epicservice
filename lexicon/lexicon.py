...
class Lexicon:
    ...
    BUTTON_USER_LIST_ITEM = "Користувач {user_id} (списків: {lists_count})"
    ...
    # ВИПРАВЛЕНО: Змінено \\n на \n для коректного переносу рядків
    ...
    # ВИПРАВЛЕНО: Змінено \\n на \n
    DEPARTMENT_MISMATCH = (
        "❌ *Помилка!* Усі товари в одному списку повинні бути з одного відділу (`{department}`).\n\n"
    ...
    DELETE_WARNING_MESSAGE = "❗️ *Увага!*\n\nВаші збережені списки, старіші за 36 годин, будуть видалені через 12 годин. Якщо ви хочете зберегти їх, будь ласка, завантажте ZIP-архів зі свого архіву."
